...
function cycleServer(topology, serverDescription) {
  ...
  destroyServer(server, topology, { force: true, forceError: serverDescription.error });
...
function updateServers(topology, incomingServerDescription) {
  ...
  if (incomingServerDescription && incomingServerDescription.error) {
    cycleServer(topology, incomingServerDescription);
    return;
  }
